...
void pulse::Init(TTree *tree)
{
   ...
   //fChain->SetBranchAddress("i_evt", &event, &b_event); // TimingDAQ
   ...
   //fChain->SetBranchAddress("V_peak", amp, &b_amp); // TimingDAQ
   //fChain->SetBranchAddress("baseline", base, &b_base); // TimingDAQ
   //fChain->SetBranchAddress("t_peak", xmin, &b_xmin); // TimingDAQ
   fChain->SetBranchAddress("amp", amp, &b_amp); // TimingDAQ
   ...
   fChain->SetBranchAddress("gauspeak", gauspeak, &b_gauspeak); // TimingDAQ
   //fChain->SetBranchAddress("gaus_mean", gauspeak, &b_gauspeak); // TimingDAQ
   ...
   //fChain->SetBranchAddress("fallingtime", fallingTime, &b_fallingTime); // TimingDAQ
