...
if (args.inputPixelFile is None):
    os.system("./VMEDat2Root --input_file={0} --output_file={1} --N_evts={2} --config={3} --save_meas".format(args.inputDatFile, args.outputFile, args.nEvents, args.config, args.inputPixelFile))
else:
