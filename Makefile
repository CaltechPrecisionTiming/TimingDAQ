...
TARGETS3 = ConvertDat2Root ConvertDat2RootWithPixels
SRC3 =  src/Aux.cc src/Config.cc

all : $(TARGETS) $(TARGETS2) $(TARGETS3)
...
$(TARGETS3) : Convert% : $(SRC3:.cc=.o) app/Convert%.cc
	@echo Building $@
	$(LD) $(CPPFLAGS) -o $@ $^ $(LDFLAGS)
...
#	rm -rf *.o app/*.o src/*.o $(TARGETS) $(TARGETS2) *~ *.dSYM
	rm -rf *.o app/*.o src/*.o $(TARGETS) $(TARGETS2) $(TARGETS3) *~ *.dSYM	
